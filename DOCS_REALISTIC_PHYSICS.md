...
- **Боковая скорость** ограничена 80% от продольной — предотвращает неуправляемый занос при поворотах >90°
- Боковая скорость затухает даже при активном рулении (мягкое затухание 0.98/субшаг)
...
Требуется версия мода: **20** (VERSION=20)
