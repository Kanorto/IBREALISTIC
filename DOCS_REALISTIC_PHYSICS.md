...
- **8 типов поверхностей** — от сухого асфальта до льда
- **Визуальный наклон** — лодка наклоняется при торможении/разгоне
...
|-------------|--------|---------|-----------------|-----------|--------------|----------|
| **ASPHALT_DRY** | 0.85 | 0.70 | 45000 | 0.15 | 0.012 | Сухой асфальт — максимальное сцепление |
| **ASPHALT_WET** | 0.55 | 0.40 | 35000 | 0.20 | 0.015 | Мокрый асфальт — аквапланирование |
| **GRAVEL** | 0.55 | 0.50 | 20000 | 0.40 | 0.030 | Гравий — непредсказуемое сцепление |
| **DIRT** | 0.45 | 0.40 | 16000 | 0.50 | 0.035 | Грунт — мягкая поверхность |
| **MUD** | 0.30 | 0.25 | 10000 | 0.60 | 0.050 | Грязь — минимальное сцепление |
| **SNOW** | 0.30 | 0.22 | 14000 | 0.35 | 0.025 | Снег — скользко с малым сопротивлением |
| **ICE** | 0.10 | 0.07 | 6000 | 0.25 | 0.008 | Лёд — очень скользко |
| **SAND** | 0.40 | 0.35 | 12000 | 0.55 | 0.060 | Песок — высокое сопротивление |

### Привязка к блокам Minecraft

| Minecraft блок | Поверхность |
|---------------|-------------|
| `stone`, `deepslate`, `blackstone`, `smooth_stone`, `obsidian` | ASPHALT_DRY |
| `cobblestone`, `mossy_cobblestone`, `andesite`, `granite`, `tuff` | ASPHALT_WET |
| `gravel` | GRAVEL |
| `dirt`, `grass_block`, `dirt_path`, `podzol`, `mycelium` | DIRT |
| `mud`, `soul_sand`, `soul_soil` | MUD |
...
- Максимальный угол: ±25°
- Формула: `visualPitch = -(ax / g) * 0.15 * 15°`
