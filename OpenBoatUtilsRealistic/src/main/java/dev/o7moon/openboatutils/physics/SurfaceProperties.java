...
public class SurfaceProperties {
    ...
    public static HashMap<String, SurfaceProperties> getBlockSurfaceMap() {
        if (blockSurfaceMap == null) {
            ...
            blueIce.corneringStiffness = 4000f;
