...
| `YAW_RATE_DAMPING` | `float` | `0.98f` | Демпфирование угловой скорости |
...
| `steeringSpeed` | `float` | `2.5f` | Скорость поворота руля (рад/с) |
...
| `speedSteeringFactor` | `float` | `0.0003f` | Фактор снижения руления от скорости |
...
|-----|--------|---------|-----------|-------|---------|-------|---------|----------|
| `ASPHALT_DRY` | 0.85 | 0.70 | 45000 | 0.15 | 0.012 | 8.0 | 0.7 | 0.10 |
| `ASPHALT_WET` | 0.55 | 0.40 | 35000 | 0.20 | 0.015 | 10.0 | 0.6 | 0.12 |
| `GRAVEL` | 0.55 | 0.50 | 20000 | 0.40 | 0.030 | 14.0 | 0.3 | 0.15 |
| `DIRT` | 0.45 | 0.40 | 16000 | 0.50 | 0.035 | 16.0 | 0.25 | 0.18 |
| `MUD` | 0.30 | 0.25 | 10000 | 0.60 | 0.050 | 18.0 | 0.2 | 0.20 |
| `SNOW` | 0.30 | 0.22 | 14000 | 0.35 | 0.025 | 12.0 | 0.35 | 0.16 |
| `ICE` | 0.10 | 0.07 | 6000 | 0.25 | 0.008 | 6.0 | 0.5 | 0.08 |
| `SAND` | 0.40 | 0.35 | 12000 | 0.55 | 0.060 | 15.0 | 0.2 | 0.22 |
