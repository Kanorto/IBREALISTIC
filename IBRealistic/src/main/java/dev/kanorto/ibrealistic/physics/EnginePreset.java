...
public enum EnginePreset {
    // name, engineForceMultiplier, engineBrakingMultiplier, dragMultiplier, requiredLevel, price
    STOCK(0, 1.0f, 1.0f, 1.0f, 0, 0),
    SPORT(1, 1.15f, 1.10f, 1.02f, 5, 800),
    RALLY(2, 1.30f, 1.20f, 1.05f, 10, 1200),
    TURBO(3, 1.50f, 1.05f, 1.10f, 15, 2000),
    MONSTER(4, 1.80f, 0.90f, 1.15f, 20, 3000);
