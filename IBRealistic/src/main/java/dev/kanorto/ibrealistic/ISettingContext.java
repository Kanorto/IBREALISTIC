...
public interface ISettingContext {
    boolean enabled();
    boolean settingHasPerBlock(IBRealistic.PerBlockSettingType setting);
    float getPerBlockForBlock(IBRealistic.PerBlockSettingType setting, String blockid);
    float getNearbySetting(/*$ boat >>*/ BoatEntity instance, IBRealistic.PerBlockSettingType setting);
    float defaultPerBlock(IBRealistic.PerBlockSettingType setting);
    ...
    void setBlocksSetting(IBRealistic.PerBlockSettingType setting, List<String> blocks, float value);
    void setBlockSetting(IBRealistic.PerBlockSettingType setting, String block, float value);
